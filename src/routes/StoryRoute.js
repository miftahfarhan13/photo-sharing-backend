...
import { createStory, deleteStory, getMyFollowingStories, getMyStories, getStoryById, getViewsByStoryId } from '../controllers/StoryController.js'
...
router.get('/api/v1/my-story', isAuth, getMyStories)
